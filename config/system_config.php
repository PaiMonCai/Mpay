...
return [
    ...
    'runtime' => [
        ...
        'rules' => [
                ...
                'control' => [
                    [
                        'rule' => [
                            ...
                            'receipt_watcher_builtin_alipay_enabled',
                ...
                'control' => [
                    [
                        'rule' => [
                            ...
                            'receipt_watcher_login_retry_max',
                        ],
                        'value' => '1',
                        'method' => 'display',
                    ],
            ...
            [
                'type' => 'switch',
                'field' => 'receipt_watcher_builtin_alipay_enabled',
                'title' => '内置支付宝账单 OpenAPI watcher',
                'value' => '0',
                'props' => $switchProps,
            ],
            [
                ...
                'title' => '外置 watcher 授权码',
                'value' => '',
                'props' => [
                    'placeholder' => '仅外置 watcher 需要；内置支付宝 OpenAPI watcher 可留空',
                ],
            ],
            [
                'type' => 'textarea',
            ...
            [
                'type' => 'inputNumber',
                'field' => 'receipt_watcher_prelogin_interval_seconds',
                'title' => '定时登录间隔(秒)',
                'value' => 600,
                'props' => [
                    'placeholder' => '请输入账号登录态预热间隔',
                    'min' => 60,
                    'max' => 86400,
                    'step' => 60,
                ],
            ...
            [
                'type' => 'inputNumber',
                'field' => 'receipt_watcher_login_retry_max',
                'title' => '登录失败最大重试次数',
                'value' => 10,
                'props' => [
                    'placeholder' => '请输入单次预登录最多尝试登录次数',
                    'min' => 1,
                    'max' => 100,
                    'step' => 1,
                ],
