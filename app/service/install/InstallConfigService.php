...
class InstallConfigService extends BaseService
{
    ...
    public function ensureDatabase(array $config): void
    {
        ...
        // Docker/MySQL commonly provisions the database and a least-privileged
        // application user before MPAY starts. If that database is already
        // reachable, do not require global CREATE DATABASE permission.
        try {
